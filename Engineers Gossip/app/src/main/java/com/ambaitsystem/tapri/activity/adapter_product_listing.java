...
public class adapter_product_listing extends RecyclerView.Adapter<adapter_product_listing.MyViewHolder> {
    ...
    public adapter_product_listing(List<Data> horizontalList, Context context) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView imageView;
        TextView txtview, txtaddtocard;
        TextView txtview_likes, txtviewproducts,txtview12;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.product_listing_row, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        if (horizontalList.get(position).txt.contains("#"))
        {
            ...
            if (context instanceof Product_listing) {
                ...
                holder.txtaddtocard.setVisibility(View.VISIBLE);
                holder.txtviewproducts.setVisibility(View.VISIBLE);
            }
            ...
            else
            {
                ...
                holder.txtaddtocard.setVisibility(View.GONE);
                holder.txtviewproducts.setVisibility(View.GONE);
