...
public class adapter_main_top_users extends RecyclerView.Adapter<adapter_main_top_users.MyViewHolder> {
    ...
    public adapter_main_top_users(List<Data> horizontalList, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.top_horizontal_user_row, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        if (horizontalList.get(position).txt.contains("#"))
        {
            ...
            try {
                if(Name_withhas.contains("ALL") || Name_withhas.contains("INVITE"))
                    holder.txtview.setTextColor(Color.parseColor("#E91E63"));
                else
                    holder.txtview.setTextColor(Color.parseColor("#8c000000"));
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        try {
                            ...
                            } else if (list.contains("0#INVITE")) {
